  ...
  return (
    <>
      <div className="max-w-3xl p-4 text-gray-800 bg-white rounded-lg shadow" data-aos={props.animation}>
        <div className="mb-2">
          <div className="h-3 text-3xl text-left  text-primary">“</div>
          ...
          <div className="h-3 text-3xl text-right text-primary">”</div>
          <div className="text-center">
            <h5 className="font-bold text-primary">{props.name}</h5>
