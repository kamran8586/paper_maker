...
const Form = () => {
  return (
    <>
      <Section_Heading text="Contact Us" width={44} />
      <div
        data-aos="zoom-in-up"
        ...
        <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="mt-8">
              <input
                type="submit"
                className="uppercase text-sm font-bold tracking-wide bg-primary text-gray-100 p-3 w-full focus:outline-none hover:cursor-pointer hover:shadow-lg text-secondary focus:shadow-green-300 focus:shadow-lg hover:shadow-green-300 transition-all duration-200"
                value="Send Message"
              />
            </div>
          </form>
